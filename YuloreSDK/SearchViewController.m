...
@interface SearchViewController ()  <UITableViewDataSource, UITableViewDelegate, UISearchDisplayDelegate, UIAlertViewDelegate, PWLoadMoreTableFooterDelegate> {
...
- (void)viewDidLoad
{
  ...
  cellCount = 8;          //load your data, here is only demo purpose
  [self check];
